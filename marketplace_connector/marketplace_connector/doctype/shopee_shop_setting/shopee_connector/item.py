...
class Item(BaseModule):
    ...
    def add(self, product_data_shopee):
        ...
        return self.client.execute("/api/v2/product/add_item", "POST", product_data_shopee)
    
    # tambahan untuk upload image
    def upload_image(self, **kwargs):
        """
        Use this call to upload product item images.

        :param kwargs:
        :return:
            - image_info: {image_id (image's ID), image_url_list {image_url_region, image_url}}
        """
        return self.client.execute("/api/v2/media_space/upload_image", "POST", kwargs)
    ...
    def addDiscount(self, **kwargs):
        ...
        return self.client.execute("/api/v2/discount/add_discount_item", "POST", kwargs)
    ...
    def deleteDiscount(self, **kwargs):
        ...
        return self.client.execute("/api/v2/discount/delete_discount_item", "POST", kwargs)
    ...
    def updateDiscount(self, **kwargs):
        ...
        :return:
        """
        return self.client.execute("/api/v2/discount/update_discount_item", "POST", kwargs, 1)
    ...
    def delete(self, **kwargs):
        ...
        return self.client.execute("/api/v2/product/delete_item", "POST", kwargs)
    ...
    def get_item_detailV1(self, **kwargs):
        """
        Use this call to get detail of item
        :param kwargs:
        :return:
        """
        return self.client.execute("item/get", "POST", kwargs, 1)
        #return self.client.execute("/api/v2/product/get_item_base_info", "GET", kwargs)
    ...
    def get_item_list(self, **kwargs):
        ...
        return self.client.execute("/api/v2/product/get_item_list", "GET", kwargs)
    ...
    def update(self, update_data):
        ...
        return self.client.execute("/api/v2/product/update_item", "POST", update_data)
    ...
    def update_price(self, **kwargs):
       ...
       # return self.client.execute("items/update_price", "POST", kwargs)
        return self.client.execute("/api/v2/product/update_price", "POST", kwargs)
    ...
    def update_stock(self, **kwargs):
        ...
        return self.client.execute("/api/v2/product/update_stock", "POST", kwargs)
    ...
    def get_attributes(self, **kwargs):
        ...
        return self.client.execute("/api/v2/product/get_attributes", "GET", kwargs)
    ...
    def get_categories(self, **kwargs):
        ...
        return self.client.execute("/api/v2/product/get_shop_category_list", "GET", kwargs)
    ...
    def boost_item(self, **kwargs):
        ...
        return self.client.execute("/api/v2/product/boost_item", "POST", kwargs)
    ...
    def get_boosted_items(self, **kwargs):
        ...
        return self.client.execute("/api/v2/product/get_boosted_list", "POST", kwargs)
    ...
    def set_item_installment_tenures(self, **kwargs):
        ...
        return self.client.execute("/api/v2/payment/get_item_installment_status", "POST", kwargs)
    ...
    def reply_comment(self, **kwargs):
        ...
        return self.client.execute("/api/v2/product/reply_comment", "POST", kwargs)

    def get_model_list(self, **kwargs):
        """
        Use this call to get a product model list.
        :param kwargs:
        :return:
        """
        return self.client.execute("/api/v2/product/get_model_list", "GET", kwargs)

    def add_model(self, **kwargs):
        """
        Use this call to add a product model.
        :param kwargs:
        :return:
        """
        return self.client.execute("/api/v2/product/add_model", "POST", kwargs)

    def update_model(self, **kwargs):
        """
        Use this call to update a product model.
        :param kwargs:
        :return:
        """
        return self.client.execute("/api/v2/product/update_model", "POST", kwargs)

    def delete_model(self, **kwargs):
        """
        Use this call to delete a product model.
        :param kwargs:
        :return:
        """
        return self.client.execute("/api/v2/product/delete_model", "POST", kwargs)
