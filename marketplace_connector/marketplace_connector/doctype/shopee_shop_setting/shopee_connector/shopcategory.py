...
class ShopCategory(BaseModule):
    ...
    def add_items(self, **kwargs):
        ...
        return self.client.execute("/api/v2/shop_category/add_item_list", "POST", kwargs)
    ...
    def delete_shop_category(self, **kwargs):
        ...
        return self.client.execute("/api/v2/shop_category/delete_shop_category", "POST", kwargs)
    ...
    def add_shop_category(self, **kwargs):
        ...
        return self.client.execute("/api/v2/shop_category/add_shop_category", "POST", kwargs)
    ...
    def get_items(self, **kwargs):
        ...
        return self.client.execute("/api/v2/shop_category/get_item_list", "POST", kwargs)
    ...
    def get_shop_category(self, **kwargs):
        ...
        return self.client.execute("/api/v2/shop_category/get_shop_category_list", "POST", kwargs)
    ...
    def update_shop_category(self, **kwargs):
        ...
        return self.client.execute("/api/v2/shop_category/update_shop_category", "POST", kwargs)