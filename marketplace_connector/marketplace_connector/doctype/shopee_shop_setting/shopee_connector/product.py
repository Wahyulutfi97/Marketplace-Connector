...
class Product(BaseModule):
    ...
    def add(self, product_data):
        ...
        return self.client.execute("/api/v2/product/add_item", "POST", product_data)
    ...
    def get_item_detail(self, **kwargs):
        ...
        return self.client.execute("/api/v2/product/get_item_base_info", "POST", kwargs)
    ...
    def get_item_ex_detail(self, **kwargs):
        ...
        :return:
        """
        return self.client.execute("/api/v2/product/get_item_extra_info", "POST", kwargs)
    ...
    def get_item_list(self, **kwargs):
        ...
        return self.client.execute("/api/v2/product/get_item_list", "POST", kwargs)
    ...
    def update(self, update_data):
        ...
        return self.client.execute("/api/v2/product/update_item", "POST", kwargs)
