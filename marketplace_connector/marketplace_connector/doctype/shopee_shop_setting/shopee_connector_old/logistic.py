...
class Logistic(BaseModule):
    ...
    def get_address(self):
        ...
        return self.client.execute("logistics/get_address_list", "GET")
    ...
    def get_branch(self, **kwargs):
        ...
        return self.client.execute("logistics/get_branch_list", "POST", kwargs)
    ...
    def get_logistic_message(self, **kwargs):
        ...
        return self.client.execute("logistics/get_tracking_info", "POST", kwargs)
    ...
    def get_order_logistic(self, **kwargs):
        ...
        return self.client.execute("logistics/get_order_list", "POST", kwargs)
    ...
    def get_parameter_for_init(self, **kwargs):
        ...
        return self.client.execute("logistics/get_shipping_parameter", "POST", kwargs)
