...
class Order(BaseModule):
    ...
    def get_order_list(self, **kwargs):
        ...
        return self.client.execute("orders/get_order_list", "POST", kwargs)
    ...
    def get_order_detail(self, **kwargs):
        ...
        return self.client.execute("orders/get_order_detail", "POST", kwargs)
    ...
    def get_order_escrow_detail(self, **kwargs):
        ...
        return self.client.execute("payment/get_escrow_detail", "POST", kwargs)
    ...
    def get_order_by_status(self, **kwargs):
        ...
        return self.client.execute("orders/get_order", "POST", kwargs)
    ...
    def cancel_order(self, **kwargs):
        ...
        return self.client.execute("orders/cancel_order", "POST", kwargs)
    ...
    def accept_buyer_cancellation(self, **kwargs):
        ...
        return self.client.execute("orders/handle_buyer_cancellation", "POST", kwargs+"&amp;operation=ACCEPT")
    ...
    def reject_buyer_cancellation(self, **kwargs):
        ...
        return self.client.execute("orders/handle_buyer_cancellation", "POST", kwargs+"&amp;operation=REJECT")
